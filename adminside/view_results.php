        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card2">
                        <div class="header">
                            <h4 class="title">List of Results</h4>
                        </div>
                        <div class="content table-responsive table-full-width" id="myTable">
                            <table class="table table-hover table-striped">
                                ...
                                <?php
                                    ...
                                    $sql = "SELECT user.*, quiz.Topic, quiz.Age, results.TotalCorrect, results.TotalAnswered FROM results LEFT JOIN user ON results.UserId = user.userid LEFT JOIN quiz ON results.QuizId = quiz.ID";
                                    ...
                                    while ($rows = mysqli_fetch_array($result)) { //fetch inside an array name as row
                                        ...
                                        echo "<td>".$rows['Topic']. ' (' . $rows['Age']. ')' ."</td>";
                                        echo "<td>".$rows['TotalAnswered']."</td>";
                                        echo "<td>".$rows['TotalCorrect']."</td>";
